                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Kullanıcı  Güncelleme</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input style="padding: 6px 12px;" type="text" name="kadi" required class="form-control"  value="<?=$sonuc["kadi"]?>">
                                    </div>
                                    <div class="form-group">
                                        <label>E-mail</label>
                                    ...
                                    <div class="form-group form-check">
                                        <label><input type="checkbox" name="aktif" <?=$sonuc['aktif']=='1'?'checked':''?> class="form-check-input">Aktif mi?</label>
                                    </div>
                                    <div class="form-group">
