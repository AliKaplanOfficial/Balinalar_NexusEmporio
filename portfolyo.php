                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal<?=$sonuc2["id"]?>">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/<?=$sonuc2["kfoto"]?>" style="width: 400px; height: 300px;" alt="" />
                            </a>
                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <ul class="list-inline">
                                        <li>Tarih: <?=$sonuc2["date"]?></li>
                                        <li>Adı: <?=$sonuc2["client"]?></li>
                                        <li>Tür Adı: <?=$sonuc2["category"]?></li>
                                    </ul>
